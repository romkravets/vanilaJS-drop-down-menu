...
var _dropDownDynamic = __webpack_require__(331);

(0, _dropDown.dropDown)('#dropDpwnCountries');
...
function dropDown(selector) {
   ...
   var btn = menuParent.querySelector('.drop-down-menu__btn');
   var list = menuParent.querySelector('.drop-down-menu__list');
   var options = menuParent.querySelectorAll('.drop-down-menu__option');
...
exports.dropDownDynamic = dropDownDynamic;
var DROP_DOWN_MENU = 'drop-down-menu';
var BTN_CLASS_NAME = 'drop-down-menu__btn';
var LIST_CLASS_NAME = 'drop-down-menu__list';

function dropDownDynamic(selector, options) {
   var menuParent = document.querySelector(selector);
   var btn = void 0;
   var list = void 0;
